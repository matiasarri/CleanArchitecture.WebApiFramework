using CleanArchitecture.WebApiFramework.Application.Features.Products.Commands;
using CleanArchitecture.WebApiFramework.Application.Features.Products.Commands.CreateProduct;
using CleanArchitecture.WebApiFramework.Application.Features.Products.Commands.DeleteProductById;
using CleanArchitecture.WebApiFramework.Application.Features.Products.Commands.UpdateProduct;
using CleanArchitecture.WebApiFramework.Application.Features.Products.Queries.GetAllProducts;
using CleanArchitecture.WebApiFramework.Application.Features.Products.Queries.GetProductById;
